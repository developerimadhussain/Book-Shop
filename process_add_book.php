...
require('database/Db_Connection.php');
	...
	if(!empty($_POST))
	{
		...
		else
		{
			...
			$query="insert into book(b_title,b_cat,b_author,b_publisher,b_edition,b_isbn,b_language,b_price,b_img)
			values('$b_title','$b_cat','$b_author','$b_publisher','$b_edition','$b_isbn','$b_language','$b_price','$b_img')";
			
			mysqli_query($conn,$query) or die($query."Can't Connect to Query...");
			header("location:admin_books.php?admin_books=1");
