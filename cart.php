...
<div class="bookshow">
	...
	<h3 id="h6">View Cart</h3>  
			...
			<?php
							...
							<button id="cart_button3" class="btn btn-outline-success my-2 my-sm-0" type="submit"><a id="a1" href="login1.php"> CONFIRM & PROCEED </a>
                                                      </button>
...
if(c==true)
{
window.location.href='del_cart.php?id='+$id+'';
return true;
}
 }
